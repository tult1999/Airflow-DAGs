...
def extract_data_from_postgres():
    conn_id='postgres_db_server'
    connector_name = 'postgres_db_server'
...
# BLOCK2: Build DAGs
with DAG('postgres_extract_data_from_db_server', schedule_interval='0 0 * * *', default_args=default_args, catchup=False) as dag:
